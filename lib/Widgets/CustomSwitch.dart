...
class MCustomSwitch extends StatefulWidget {
  ...
  const MCustomSwitch({Key key, this.value, this.onChanged, this.activeColor,this.activeTogolColor})
      : super(key: key);
                  ...
                  Expanded(
                    child: Align(
                      ...
                      child: Container(
                        ...
                        height: 40.0,
                        decoration: BoxDecoration(
                            shape: BoxShape.circle, color: _circleAnimation.value == Alignment.centerLeft
                            ? aSearchFieldColor
